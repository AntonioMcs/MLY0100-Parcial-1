...
# mly0100parcial_kedro documentation build
...
from mly0100parcial_kedro import __version__ as release

# -- Project information -----------------------------------------------------

project = "mly0100parcial_kedro"
author = "Kedro"
...
htmlhelp_basename = "mly0100parcial_kedrodoc"
...
latex_documents = [
    (
        master_doc,
        "mly0100parcial_kedro.tex",
        "mly0100parcial_kedro Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "mly0100parcial_kedro",
        "Project mly0100parcial_kedro codebase.",
        "Data-Science",
    )
]
